...
*******************/
/* Allegro Newbie Tutorial : Lesson10 - Bounding Box Collision Detection
 *
...
bool loadBitmap(Image &image, char *filename);
...
int main(int argc, char *argv[])
{
	...
	if (!loadBitmap(image1, "image1.bmp"))
        return 1;
	if (!loadBitmap(image2, "image2.bmp"))
        return 1;
    setPosition(image1, 50, 50);
